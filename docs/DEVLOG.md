# Nhật ký triển khai — Celesnity Factory Platform

Xem [README.md](../README.md) để biết tổng quan dự án, cách chạy, và Assessment Assumptions. File này là nhật ký triển khai đầy đủ — từng bug, từng quyết định, từng bằng chứng log/curl thật — giữ nguyên văn, không tóm tắt.
